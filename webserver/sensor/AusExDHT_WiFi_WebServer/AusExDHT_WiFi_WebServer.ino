...
#define SENSOR_PIN 1             // センサはデジタルの1番ピンに接続
// センサの種別の選択
//#define DHTTYPE    DHT11       // DHT 11
#define DHTTYPE    DHT22       // DHT 22 (AM2302)
//#define DHTTYPE    DHT21       // DHT 21 (AM2301)

#define SSID_STR "IoTPi0"
#define WIFI_PASS "IoT-Nets"
...
#define APP_NAME "AusExDHT_WiFi_HttpServer" // syslog形式のログ出力に利用
...
IPAddress gatewayAddress(192, 168, 1, 254);
...
void setup() {
  ...
  // Initialize device.
  dht.begin();
  Serial.println(F("DHT Unified Sensor Example"));
