...
/* 端末が眠る期間の指定 */
#define SLEEP_DURATION 20 //単位の倍数
...
#if defined(ARDUINO_SLEEP_XBEE) || defined(ARDUINO_SLEEP_RTC)
...
#endif /* AVR */
#endif /* ARDUINO_SLEEP_XBEE || ARDUINO_SLEEP_RTC */
...
#endif /* ARDUINO_SLEEP_XBEE */

#ifdef ARDUINO_SLEEP_RTC
volatile boolean rtcInter = false;
/*
 * RTC(CLKOUT)からの外部割込みで実行される関数
 */
void InterRTC()
